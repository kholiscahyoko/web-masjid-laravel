...
<body>
            ...
            <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded">
                <div class="container flex flex-wrap justify-between items-center mx-auto">
                    <a href="{{ url('/') }}" class="flex items-center">
                        <img src="{{ url('/img/logo-masjid.png') }}" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
                        <span class="self-center text-xl font-semibold whitespace-nowrap text-yellow-800">Web Masjid</span>
                    </a>
    ...
    <div class="container mx-auto">
        <div class="flex justify-between">
            <div class="jadwal-shalat flex items-center">
                <div class="bg-gray-400 px-10 text-center">Isya</div>
                <div class="bg-yellow-800 px-10 text-center">Subuh</div>
                <div class="bg-yellow-200 px-10 text-center">Dhuhur</div>
                <div class="bg-yellow-400 px-10 text-center">Ashar</div>
                <div class="bg-orange-400 px-10 text-center">Maghrib</div>
            </div>
        </div>
    </div>
</body>
